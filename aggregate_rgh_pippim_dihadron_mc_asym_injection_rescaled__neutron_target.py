...
def get_plots(
    ...
    if alternate_rg == 'rgc':
        rgh_data_counts = rga_data_counts * 1/np.square(y_ratio_v2_err) * 100/16.3 * 5/14 * 3/20 / (0.20) #NOTE: IMPORTANT!!! THIS IS ONLY  A VALID CONVERSION FACTOR FOR RGC!
    ...
    if alternate_rg == 'rgc':
        ...
        scale_factor = 1/np.square(y_ratio_v2_err) * 100/16.3 * 5/14 * 3/20 / (0.20) #NOTE: FOR RGC #NOTE: AS OF 10/21/24 NO DILUTION FACTOR HERE SINCE RGC ALSO HAS NH3 TARGET
...
if __name__=="__main__":
    ...
    base_dir    = "results_pippimdihadronbsaanalysis_mc_asym_injection_rgh_neutron_target_noSector4__4_19_24/" #NOTE: DON'T FORGET ABOUT NOSECTOR4 SCENARIO
    alternate_rg = 'rgc'
