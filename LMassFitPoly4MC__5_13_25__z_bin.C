...
void LMassFitPoly4MC__5_13_25__z_bin() {
    ...
    std::string nomultiplicitycut = "!TMath::IsNaN(costheta1_mc) && !TMath::IsNaN(costheta2_mc) && sqrt(px_e*px_e+py_e*py_e+pz_e*pz_e)>2.0 && vz_e>-25.0 && vz_e<20.0";
    std::string cuts_all = "mass_ppim<1.24 && Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0 && detector_p==6 && detector_pim==6 && z_ppim>=0.6856 && z_ppim<0.7698";//Q2>=2.663 && Q2<11.0                                                 
    ...
    std::string name = "LMassFitPoly4MC__5_13_25__z_bin";
    ...
    if (delVal<0.20) {
      ...
      m0 = varMax*1.025;//COMMENTED OUT FOR DEBUGGING: HIGH Y BIN: varMax; and replaced with 1.25...                                                                                                          
