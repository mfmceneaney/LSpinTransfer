...
void getStatistics_neutron_target() {

    // Set input parameters
    std::string path_rgh_mc = "/volatile/clas12/users/mfmce/mc_jobs_rgh_pipm_neutron_target_4_12_24/skim_pipim_*.root";
    ...
    std::string path_rgc_mc = "/volatile/clas12/users/mfmce/mc_jobs_rgc_pipm_neutron_target_4_12_24/skim_pipim_*.root";
    std::string path_rgc_dt = "/volatile/clas12/users/mfmce/data_jobs_rgc_pi_neutron_target_4_8_24__BACKUP__/skim_pipim_*.root";
    std::string tree        = "t";
    ...
    std::string rgc_mc_name = "h1_rgc_mc_neutron_target";
    ...
    std::string rgc_dt_name = "h1_rgc_dt_neutron_target";
    ...
    std::string rgh_mc_name = "h1_rgh_mc_neutron_target";
