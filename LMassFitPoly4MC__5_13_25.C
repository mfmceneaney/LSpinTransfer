...
void LMassFitPoly4MC__5_13_25() {
    ...
    std::string cuts_all = "mass_ppim<1.24 && Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0 && detector_p==6 && detector_pim==6";//Q2>=2.663 && Q2<11.0                                                 
    ...
    std::string name = "LMassFitPoly4MC__5_13_25";
