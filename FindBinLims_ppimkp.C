...
void FindBinLims_ppimkp() {
    ...
    const char *path    = "/volatile/clas12/users/mfmce/data_jobs_rga_ppimkp_3_18_24/skim_*.root";//"~/clas12work/skim_Lambda_ROOT_12_9_20/*.root";
    const char *tree    = "t";
    const char *cuts    = "mass_ppim<1.24 && Q2>1 && W>2 && p_e>2.0 && vz_e>-25.0 && vz_e<20.0 && y<0.8 && xF_ppim<0.0 && xF_k>0.0 && xF_ppim>-1.0 && zeta_ppim<1.0";//"Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0";
