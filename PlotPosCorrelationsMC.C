...
void PlotPosCorrelationsMC() {
    ...
    std::string extraname = Form("mc_rga_pos_detector_%d",detector_identifier); // "mc_rgh_neg";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotPosCorrelationsMC.root","RECREATE");
    f->cd();
