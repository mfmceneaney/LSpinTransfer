...
# Set paths
base_dir = "/Users/mfm45/drop/GetBinMigration2D__Inverse__MCSmear__mom_only__5_14_25"
paths = [
    os.path.join(base_dir,"sg/h_bin_migration_2D_final_bins.root"),
    os.path.join(base_dir,"bg/h_bin_migration_2D_final_bins.root")
]
out_dir = os.path.abspath("compare_bin_migration_matrices_mcsmear__mom_only")
