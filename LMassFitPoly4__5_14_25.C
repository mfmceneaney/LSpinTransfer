...
void LMassFitPoly4__5_14_25() {
  
    std::string tree = "t";
    std::string path = "/work/clas12/users/mfmce/data_jobs_rga_ppim_2_14_24__BACKUP_LEGACY_DO_NOT_DELETE/skim_*.root";
    ...
    std::string name = "LMassFitPoly4__5_14_25";
    ...
    func->SetParLimits(0,0.0,3.0);//NOTE: WAS 0.0,3.0
    //DEBUGGING: 5/14/25 COMMENT: func->SetParLimits(5,h->GetBinContent(nbins)*1.0,h->GetBinContent(nbins)*2.0);//NOTE: DEBUGGING: 4/7/25: 0.98 10.0
    // func->SetParLimits(7,0.0,1.26);
    // func->SetParLimits(1,2.0,100.0);
    func->SetParLimits(1,2.0,10.0);

    //KEEP THESE ORIGINAL PARAMETER LIMITS
    // func->SetParLimits(0,0.0,3.0);//DEBUGGING: 5/14/25
    // func->SetParLimits(1,2.0,10.0);//DEBUGGING: 5/14/25
    ...
    i_sig_err = TMath::Sqrt(i_fitf + TMath::Power(i_bg_err,2));
