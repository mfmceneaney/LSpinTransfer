...
void analysis(const YAML::Node& node) {
    ...
    std::cout << "sig_pdf_name: " << sig_pdf_name << std::endl;
    ...
    std::cout << "use_sb_subtraction: " << use_sb_subtraction << std::endl;
