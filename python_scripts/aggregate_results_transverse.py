...
if __name__=="__main__":
    ...
    methods = {"method":["transverse","LF"]}
    fitvars = {"fitvar":["costhetaT1","costhetaT2"]}
    ...
    ylimss = [-0.5,0.5]
    titles = {
        'costhetaT1':'Spontaneous Transverse Polarization $P_{\Lambda} \perp \\vec{p}_e \\times \\vec{p}_{\Lambda}$',
        'costhetaT2':'Spontaneous Transverse Polarization $P_{\Lambda} \perp \\vec{p}_e \\times \\vec{p}_{\gamma^{*}}$',
    }
    colors = {
        'costhetaT1':'blue',
        'costhetaT2':'red',
