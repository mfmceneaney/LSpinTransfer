...
#RGA
version = '11_8_24' #'10_22_24' #'7_16_24' #'7_15_24' #'7_3_24' #'6_18_24' #'5_13_24'#'5_10_24'#'5_3_24'#'5_2_24' #'4_30_24'
...
inscalingdir = '/Users/mfm45/drop/rgh_projections_'+version+'/results_pippimdihadronbsaanalysis_mc_asym_injection_rgh'+use22GeV_name+neutron_target_name+noSector4_name+'__4_19_24__PLOTS_AND_TABLES__'+version+'/csv/'
...
for i, name in enumerate(infiles):
    ...
    # Save scaled data
    outname = name.replace('.csv','_rescaled_'+run_group+use22GeV_name+neutron_target_name+noSector4_name+'_'+version+'.csv').replace('harut','dihadron')
    ...
    if i!=3 or True:
        ...
        h_root_path = '/Users/mfm45/drop/rgh_projections_'+version+'/getStatistics'+use22GeV_name+neutron_target_name+'/' #root_files_5_1_24/'
