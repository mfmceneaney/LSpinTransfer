...
void LMassFitMC_DOUBLE_POLY2() {
    ...
    std::string name = "LMassFitMC_DOUBLE_POLY2";
    ...
    TF1 *func = new TF1("fit","[4]*ROOT::Math::crystalball_function(-x,[0],[1],[2],-[3]) + [5]*(1 - [6]*(x-[7])*(x-[7])-[8]*(x-[9])*(x-[9]))",varMin,varMax);
    ...
    func->SetParameters(alpha_init,n_init,sigma_init,1.1157,sig_max_init,hmax,beta,m0,par8,par9);
    func->SetParNames("alpha","n","sigma","Mu","C1","Pol2 max","Pol2 beta","Pol2 M0","Par8","Par9");
    ...
    // Set the bg fn:
    TF1 *bg = new TF1("bg","[0]*(1 - [1]*(x-[2])*(x-[2]) - [3]*(x-[4])*(x-[4]))",varMin,varMax);
    bg->SetParameters(a0,a1,a2,a3,a4);
    Double_t errsBg[] = {Ea0,Ea1,Ea2,Ea3,Ea4};
