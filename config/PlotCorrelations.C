...
void PlotCorrelations() {
    ...
    const char *tree1    = "t";
    const char *cuts1    = "mass_ppim<1.24 && Q2>1 && W>2 && p_e>2.0 && vz_e>-10 && vz_e<2.5 && detector_p==6 && detector_pim==6 && vz_e>-10 && vz_e<2.5";//"Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0";
    ...
    const char *tree2    = "t";
    const char *cuts2    = "mass_ppim<1.24 && Q2>1 && W>2 && p_e>2.0 && vz_e>-10 && vz_e<2.5 && detector_p==6 && detector_pim==6 && vz_e>-10 && vz_e<2.5";//"Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0";
    // const char *drawopt  = "";//"PE1";
