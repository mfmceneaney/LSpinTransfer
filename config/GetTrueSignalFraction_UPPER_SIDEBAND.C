...
void GetTrueSignalFraction_UPPER_SIDEBAND() {
    ...
    const char *sigcut  = "mass_ppim>1.14 && mass_ppim<1.18";
    const char *drawopt = "APE";
    const char *name = "GetTrueSignalFraction_UPPER_SIDEBAND";
...
} // GetTrueSignalFraction_UPPER_SIDEBAND()
