...
void plot(ROOT::RDF::RInterface<ROOT::Detail::RDF::RJittedFilter, void> d1,
        ...
        ROOT::RDF::RInterface<ROOT::Detail::RDF::RJittedFilter, void> d4,
  ...
  h_mc_40nA->SetMarkerColor(4); // 2 is red
  h_mc_40nA->SetMarkerSize(0.5);
  h_mc_40nA->SetLineColor(4); // 2 is red
  ...
  h_mc_nobkg->SetMarkerColor(8); // 2 is red
  h_mc_nobkg->SetMarkerSize(0.5);
  h_mc_nobkg->SetLineColor(8); // 2 is red
  h_mc_nobkg->SetLineWidth(1);

  // Draw histogram
  h_data->Draw(drawopt);
  h_mc->Draw(drawopt);
  h_mc_40nA->Draw(drawopt);
  h_mc_nobkg->Draw(drawopt);
  ...
  h_stack->Add(h_data);
  h_stack->Add(h_mc);
  h_stack->Add(h_mc_40nA);
  h_stack->Add(h_mc_nobkg);
...
void PlotComparisons3MCSample() {
    ...
    const char *path1    = "/RGA_DT_DIR/skim_*.root";//"~/clas12work/skim_Lambda_ROOT_12_9_20/*.root";
    const char *tree1    = "t";
    ...
    const char *path2    = "/RGA_MC_DIR/skim_*.root";//"~/clas12work/skim_Lambda_ROOT_12_9_20/*.root";
    const char *tree2    = "t";
    const char *cuts2    = "mass_ppim<1.24 && Q2>1 && W>2 && p_e>2.0 && vz_e>-10 && vz_e<2.5 && detector_p==6 && detector_pim==6";//"Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0";
    // const char *drawopt  = "";//"PE1";

    // Parameters for MC tree 40nA
    const char *path3    = "/RGA_MC_40nA_DIR/skim_*.root";//"~/clas12work/skim_Lambda_ROOT_12_9_20/*.root";
    const char *tree3    = "t";
    const char *cuts3    = "mass_ppim<1.24 && Q2>1 && W>2 && p_e>2.0 && vz_e>-10 && vz_e<2.5 && detector_p==6 && detector_pim==6";//"Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0";
    // const char *drawopt  = "";//"PE1";

    // Parameters for MC tree nobkg
    const char *path4    = "/RGA_MC_nobkg_DIR/skim_*.root";//"~/clas12work/skim_Lambda_ROOT_12_9_20/*.root";
    const char *tree4    = "t";
    const char *cuts4    = "mass_ppim<1.24 && Q2>1 && W>2 && p_e>2.0 && vz_e>-10 && vz_e<2.5 && detector_p==6 && detector_pim==6";//"Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0";
    // const char *drawopt  = "";//"PE1";
    ...
    // Open output file
    TFile *f = TFile::Open("PlotComparisons3MCSample.root","RECREATE");
    f->cd();

    // Get 1D Plots
    plot(frame1,frame2,frame3,frame4,"Q2",100,1.0,10.0,"Q^{2} (GeV^{2})",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"W",100,2.0,4.5,"W (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"y",100,0.0,1.0,"y",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"x",100,0.0,1.0,"x",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"mass_ppim",100,1.08,1.24,"M_{p#pi^{-}}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"z_ppim",100,0.0,1.0,"z_{p#pi^{-}}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"xF_ppim",100,-1.0,1.0,"x_{F p#pi^{-}}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"costheta1",100,-1.0,1.0,"cos(#theta) along P_{#Lambda}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"costheta2",100,-1.0,1.0,"cos(#theta) along P_{#gamma *}",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"pt_e",100,0.0,2.0,"p_{T e^{-}} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"pt_p",100,0.0,2.0,"p_{T p} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"pt_pim",100,0.0,2.0,"p_{T #pi^{-}} (GeV)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"p_e",100,0.0,10.0,"p_{e^{-}} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"p_p",100,0.0,10.0,"p_{p} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"p_pim",100,0.0,10.0,"p_{#pi^{-}} (GeV)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"pz_e",100,0.0,10.0,"p_{z e^{-}} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"pz_p",100,0.0,10.0,"p_{z p} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"pz_pim",100,0.0,10.0,"p_{z #pi^{-}} (GeV)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"theta_e",100,0.0,TMath::Pi(),"#theta_{e^{-}}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"theta_p",100,0.0,TMath::Pi(),"#theta_{p}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"theta_pim",100,0.0,TMath::Pi(),"#theta_{#pi^{-}}",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"phi_e_2",100,0.0,2*TMath::Pi(),"#phi_{e^{-}}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"phi_p_2",100,0.0,2*TMath::Pi(),"#phi_{p}",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"phi_pim_2",100,0.0,2*TMath::Pi(),"#phi_{#pi^{-}}",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"beta_e",100,0.0,1.2,"#beta_{e^{-}} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"beta_p",100,0.0,1.2,"#beta_{p} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"beta_pim",100,0.0,1.2,"#beta_{#pi^{-}} (GeV)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"chi2pid_e",100,-10.0,10.0,"#chi^{2}_{PID e^{-}} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"chi2pid_p",100,-10.0,10.0,"#chi^{2}_{PID p} (GeV)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"chi2pid_pim",100,-10.0,10.0,"#chi^{2}_{PID #pi^{-}} (GeV)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"vT_e",100,0.0,5.0,"v_{T e^{-}} (cm)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"vT_p",100,0.0,5.0,"v_{T p} (cm)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"vT_pim",100,0.0,5.0,"v_{T #pi^{-}} (cm)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"v_e",100,0.0,30.0,"v_{e^{-}} (cm)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"v_p",100,0.0,30.0,"v_{p} (cm)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"v_pim",100,0.0,30.0,"v_{#pi^{-}} (cm)",drawopt,f);

    plot(frame1,frame2,frame3,frame4,"vz_e",100,-25.0,25.0,"v_{z e^{-}} (cm)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"vz_p",100,-25.0,25.0,"v_{z p} (cm)",drawopt,f);
    plot(frame1,frame2,frame3,frame4,"vz_pim",100,-25.0,25.0,"v_{z #pi^{-}} (cm)",drawopt,f);
