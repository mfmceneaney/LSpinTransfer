...
void LMassFitMC__5_13_25__z_bin() {
    ...
    std::string cuts_all = "mass_ppim<1.24 && Q2>1 && W>2 && y<0.8 && xF_ppim>0.0 && z_ppim<1.0 && detector_p==6 && detector_pim==6 && sqrt(px_e*px_e+py_e*py_e+pz_e*pz_e)>2.0 && vz_e>-10 && vz_e<2.5 && z_ppim>=0.6856 && z_ppim<0.7698";//Q2>=2.663 && Q2<11.0                                                 
