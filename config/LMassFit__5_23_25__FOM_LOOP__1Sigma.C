...
void LMassFit__5_23_25__FOM_LOOP__1Sigma() {
    ...
    std::string name = "LMassFit__5_23_25__FOM_LOOP__1Sigma";
    ...
    // Create canvas
    TCanvas *c1 = new TCanvas("c1_1sigma");
...
N MAYBE...
    ...
    Double_t nSigmas = 1;//CHANGE THIS
    ...
    // Plot foms
    TCanvas *c_foms = new TCanvas("c_foms_1sigma");
    ...
    // Plot epsilons
    TCanvas *c_epss = new TCanvas("c_epss_1sigma");
