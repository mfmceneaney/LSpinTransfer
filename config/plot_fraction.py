...
min_len = min(len(y_theory_tfrcfr),len(y_theory_cfr))
g3_yvalues = np.divide(y_theory_tfrcfr[:min_len],y_theory_cfr[:min_len])
g3 = plt.plot(x_theory_cfr,g3_yvalues,color='tab:red',linestyle=':',linewidth=5,label='Zhao $et$ $al.$')
