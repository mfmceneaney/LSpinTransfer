...
if __name__=="__main__":
    ...
    base_dir    = "results_momc/results_phi_h_ppim_min/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    # Results phi_ppim max file paths and config
    base_dir    = "results_momc/results_phi_h_ppim_max/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/mass_fit/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/sideband/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/upper_sideband/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/lower_sideband/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/kinematics_mass_ppim/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/kinematics_xF_ppim/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    # Upper sideband systematics file paths and config
    base_dir    = "systematics_momc/upper_sideband_scan/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
    ...
    base_dir    = "systematics_momc/mc_asym_injection/"
    submit_path = base_dir+"submit.sh"
    yaml_path   = base_dir+"args.yaml"
    out_path    = base_dir+"jobs.txt"
    divisions = dict(
