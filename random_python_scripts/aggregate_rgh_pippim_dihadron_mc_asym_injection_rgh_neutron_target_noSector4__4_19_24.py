...
def get_plots(
    ...
    g2 = plt.errorbar(x_mean,y_mean,xerr=xerr_mean,yerr=yerr_mean,
                        ...
                        linewidth=linewidth, markersize=markersize,label='Mean TSSA')
...
if __name__=="__main__":
    ...
    base_dir    = "results_pippimdihadronbsaanalysis_mc_asym_injection_rgh_neutron_target_noSector4__4_19_24/" #"systematics/mc_asym_injection/"
    ...
    def apply_get_plots(out_file_list,get_outpath,get_plots,base_dir='',xlimss={},ylims=[0.0,1.0],titles={},xtitles={},ytitle='',verbose=True,aggregate_keys={},colors={},sgasyms=sgasyms,asym_name=asym_name): 
        ...
        for el in out_file_list:
            ...
            fitvar = 'sin_phi_rt_pipim_sin_theta_p1_pipim' #'sin_dphi_pipim_sin_phi_rt_pipim' #config['fitvar'] #NOTE: VARIABLE FOR COS THETA
