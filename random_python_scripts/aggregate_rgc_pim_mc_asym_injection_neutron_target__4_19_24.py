...
def get_plots(
    ...
    g2 = plt.errorbar(x_mean,y_mean,xerr=xerr_mean,yerr=yerr_mean,
                        ...
                        linewidth=linewidth, markersize=markersize,label='Mean BSA')
...
if __name__=="__main__":
    ...
    methods = {"method":["BSA"]}
    fitvars = {"fitvar":["dsin_phi_h_pim"]}
    asyms   = [-0.1, -0.01, 0.00, 0.01, 0.1]
    sgasyms = {"sgasyms":[[0.1]]}#[a] for a in asyms]}
    bgasyms = {"bgasyms":[[0.0]]}#[a] for a in asyms]}
    ...
    base_dir    = "results_pimbsaanalysis_mc_asym_injection_rgc_neutron_target__4_19_24/" #"systematics/mc_asym_injection/"
    ...
    def apply_get_plots(out_file_list,get_outpath,get_plots,base_dir='',xlimss={},ylims=[0.0,1.0],titles={},xtitles={},ytitle='',verbose=True,aggregate_keys={},colors={},sgasyms=sgasyms,asym_name=asym_name): 
        ...
        for el in out_file_list:
            ...
            fitvar = 'sin_phi_h_pim' #config['fitvar'] #NOTE: VARIABLE FOR COS THETA
