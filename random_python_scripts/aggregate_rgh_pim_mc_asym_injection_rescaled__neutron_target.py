...
if __name__=="__main__":
    ...
    fitvars = {"fitvar":["sin_phi_h_pim"]}  #"sin_dphi_pipim_sin_phi_rt_pipim"
    ...
    base_dir    = "results_pimbsaanalysis_mc_asym_injection_rgh_neutron_target_noSector4__4_19_24/" #NOTE: DON'T FORGET ABOUT NOSECTOR4 SCENARIO
    alternate_rg = 'rgc'
    ...
    def get_out_file_name(method='method',
        ...
        method = 'BSA' #'BSA2D'
        fitvar='sin_phi_h_pim' #'sin_dphi_pipim_sin_phi_rt_pipim' 
